...
/** Painel de chat genérico com um agente de IA — usado tanto pelo botão flutuante do FALA AI quanto embutido (fixo) numa tela específica, como a conversa de um lead no WhatsApp. */
